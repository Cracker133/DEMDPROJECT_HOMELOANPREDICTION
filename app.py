...
def main():
   ...
   .sidebar .sidebar-content {
    ...
    ApplicantIncome = st.text_input("ApplicantIncome","Enter Applicant Income in Thousands if any else enter 0")
    CoapplicantIncome = st.text_input("CoapplicantIncome","Enter Co-Applicant Income in Thousands if any else enter 0")
    LoanAmount = st.text_input("LoanAmount","Enter Loan Amount(0-900)k")
